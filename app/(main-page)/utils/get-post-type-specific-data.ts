...
export default function getPostTypeSpecificData({
  ...
  if (postType === "Erbjuds") {
    ...
    disclaimerText = "Kontakt med människor sker på egen risk. Vi ansvarar inte för att människor agerar lagligt och inte lurar dig. Vi kan inte garantera produktens skick därför bör du verifiera med leverantören vad varan använts till innan.";
